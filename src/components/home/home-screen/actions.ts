...
// Fetch posts and include comments, likes, and user information
...
// Delete post if user is an admin
...
// Get all posts for display, including author and related information
