...
const WelcomeEmail = ({
	...
	return (
		<Html>
			<Head />
			<Preview>Welcome to GMI!</Preview>
			<Body style={main}>
				<Container style={container}>
					<Section style={message}>
						<Img
							src={`${BASE_URL}/Agri-image2.jpg`}
							// todo => delete this one below
							// src={`https://i.postimg.cc/y6rC7LBM/Agri-image2.jpg`}
							width='600'
							height='400'
							alt='welcome icon'
							style={{ margin: "auto", borderRadius: 10 }}
						/>
						<Heading style={{ ...global.heading }}>Welcome to GMI!</Heading>
					...
					<Section style={global.defaultPadding}>
						<Text style={footer.text}>
							© {new Date().getFullYear()} GMI, Inc. All Rights Reserved.
						</Text>
					</Section>
				</Container>
			</Body>
